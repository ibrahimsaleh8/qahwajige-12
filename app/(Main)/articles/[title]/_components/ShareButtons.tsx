...
export default function ShareButtons({ title }: Props) {
  ...
  return (
    <div className="flex flex-wrap gap-3 items-center">
      <span className="text-sm text-[#b1b1b1]">شارك المقالة:</span>
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-full bg-gray-200 text-sm text-black cursor-pointer hover:bg-gray-300">
        نسخ رابط المقالة
      </button>
    </div>
  );
